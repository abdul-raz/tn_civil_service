...
const WithExplanation = () => {
  ...
  const explanationData = [
   { id: 1, title: 'Science - Series Test', type: 'Test Series', year: '2025', status: 'Active', pathUrl: 'https://tnma.devops-in22labs.com/uploads/pdf/1744347042_87069e7d586ddf68bdbf.pdf' }
  ];
  ...
  return (
    <section className='bg-white  md:p-5 px-3 py-5 rounded-md shadow-md relative'>
      ...
      {isUpdateModalOpen && <QuestionBankUpdateModal isUpdateModalOpen={isUpdateModalOpen} editDocument={editDocument} setIsUpdateModalOpen={setIsUpdateModalOpen} documentName={"withexplanation"} />}
    </section>
  );
};

export default WithExplanation;

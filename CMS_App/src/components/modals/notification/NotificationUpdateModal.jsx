...
//     categoryTypeId: editDocument?.categoryTypeId || "", // use categoryTypeId for select value
...
//         `http://localhost:3000/api/notification/${editDocument.id}`,
//         {
//           method: "PUT",
//           body: formDataObj,
//         }
...
//         // optionally refresh the notification list here or pass a callback to parent
//       } else {
...
//       >
//         <h2 className="text-lg font-semibold text-[#002147] mb-4">Update Notification</h2>
...
//               <option value="1">Admission Information</option>
//               <option value="2">Scholarship Notification</option>
...
//           <div className="md:w-[49%] w-full">
//             <label className="block mb-1 text-sm text-gray-700 font-medium">Upload PDF (optional)</label>
//             <input
//               type="file"
//               name="file"
...
//                 Current file:{" "}
//                 <a
//                   href={`${window.location.origin}/${formData.pathUrl.replace(/\\/g, "/")}`}
//                   target="_blank"
...
const NotificationUpdateModal = ({
  ...
  const fetchNotificationTypes = async () => {
    try {
      const res = await fetch("http://localhost:3000/api/masterData/notificationTypes");
      if (res.ok) {
